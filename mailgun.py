...
def send_html_message(domain, From, to, cc, bcc, subject, body, attach_files, html ):
    template = None
    files=[]
...
if __name__ == "__main__":
    ...
    response = send_html_message(args.domain, args.From, args.to, args.cc, args.bcc, args.subject, args.body, args.attach, args.html)
    print (response.text )
